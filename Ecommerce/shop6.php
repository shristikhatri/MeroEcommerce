...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dressesboy/blue4.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>This white with blue shirt is made up of 100% cotton,this shirt provides unmatched comfort 
                with each wear.This shirt is one of the best seller outfit .
            </span>
        </div>
    </section>
