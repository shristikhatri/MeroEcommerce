...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dresses girl/dotteddress3.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The dotted dress is made up of 100% cotton,this dress provides unmatched comfort 
                with each wear.This dress is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesgirl/dotteddress2.jpg" alt="">
                <div class="des">
                    <h5> Dotted dress</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
