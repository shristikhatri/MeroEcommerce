...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="arrival8.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The jeans is made up of 100% jeans,this jeans provides unmatched comfort 
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesboy/boyjeans2.jpg" alt="">
                <div class="des">
                    <h5> Jeans</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesboy/boyjeans3.jpg" alt="">
                <div class="des">
                    <h5> Jeans</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
