...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dressesboy/denim2.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The denim jacket is made up of 100% jeans,this jacket provides unmatched comfort 
                with each wear.This jacket is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesboy/denim3.jpg" alt="">
                <div class="des">
                    <h5> Denim jacket</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesboy/denim4.jpg" alt="">
                <div class="des">
                    <h5> Denim jacket</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
