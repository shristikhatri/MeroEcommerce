...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="arrival3.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The straight jeans is made up of jeans clothes,this straight-jeans provides unmatched comfort 
                with each wear.This jeans is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="dressesgirl/straightjeans.jpg" alt="">
                <div class="des">
            ...
            <div class="pro">
                <img src="dressesgirl/straightjeans2.jpg" alt="">
                <div class="des">
                    <h5> Straight jeans</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesgirl/straightjeans3.jpg" alt="">
                <div class="des">
                    <h5> Straight jeans</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
