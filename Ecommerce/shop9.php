...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="arrival1.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            <h6>Womens wear</h6>
            <h4>checked one-piece</h4>
            <h2>Rs 1800</h2>
            <select>
            ...
            <span>The cheked one piece is made up of 100% cotton,this one-piece provides unmatched comfort 
                with each wear.This checked one-piece is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesgirl/checkedone3.jpg" alt="">
                <div class="des">
                    <h5> checked one-piece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
