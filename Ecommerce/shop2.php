...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="summer2.png"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            <h6>Womens wear</h6>
            <h4>Floral one piece</h4>
            <h2>Rs 1800</h2>
            <select>
            ...
            <span>The Floral  one piece is made up of 100% cotton,this one-piece provides unmatched comfort 
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesgirl/floral2.jpg" alt="">
                <div class="des">
                    <h5> Floral onepiece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesgirl/floral3.jpg" alt="">
                <div class="des">
