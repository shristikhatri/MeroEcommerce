...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="summer1.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            <h6>Womens wear</h6>
            <h4>Button one-piece</h4>
            <h2>Rs 2000</h2>
            <select>
            ...
            <span>The button  one piece is made up of 100% cotton,this one-piece provides unmatched comfort 
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesgirl/buttondress3.jpg" alt="">
                <div class="des">
                    <h5> Button one-piece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
