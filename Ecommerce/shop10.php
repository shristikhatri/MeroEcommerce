...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="arrival4.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            <h6>Womens wear</h6>
            <h4>Shirt with checked one-piece</h4>
            <h2>Rs 1600</h2>
            <select>
            ...
            <span>The  one piece is made up of 100% cotton,this one-piece provides unmatched comfort 
                with each wear.This one-piece is one of the best seller outfit .you will be provided with shirt as well.
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="dressesgirl/shirtwithchecked.jpg" alt="">
                <div class="des">
                    <h5>Shirt with checked one-piece</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="dressesgirl/shirtwithchecked2.jpg" alt="">
                <div class="des">
                    <h5>Shirt with checked one-piece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesgirl/shirtwithchecked3.jpg" alt="">
                <div class="des">
                    <h5>Shirt with  checked one-piece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
