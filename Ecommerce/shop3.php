...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="summer3.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The white one piece is made up of 100% cotton,this one-piece provides unmatched comfort 
                with each wear.This one-piece is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="dressesgirl/piece.jpg" alt="">
                <div class="des">
                    <h5> one-piece</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="dressesgirl/piece1.jpg" alt="">
                <div class="des">
                    <h5> onepiece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="dressesgirl/piece2.jpg" alt="">
                <div class="des">
                    <h5>  one-piece</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
