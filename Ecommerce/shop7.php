...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="summer7.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The stripe shirt  is made up of 100% silk,this shirt provides unmatched comfort 
                with each wear.This stripe shirt is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="dressesboy/stripe2.jpg" alt="">
                <div class="des">
                    <h5> Stripe shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="dressesboy/stripe4.jpg" alt="">
                <div class="des">
                    <h5> Stripe shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
