...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dressesboy/beach3.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The Beach t-shirt is made up of 100% cotton,this t-shirt provides unmatched comfort 
                with each wear.This t-shirt is one of the best seller outfit .Perfect wear for summer.
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesboy/beach4.jpg" alt="">
                <div class="des">
                    <h5> Beach t-shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
