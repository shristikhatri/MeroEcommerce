...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dressesboy/checkedshirt4.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            ...
            <span>The check shirt is made up of 100% cotton,this check shirt provides unmatched comfort 
                with each wear.This check shirt is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesboy/checkedshirt3.jpg" alt="">
                <div class="des">
                    <h5> Chech shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
