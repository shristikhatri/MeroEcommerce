...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="dressesboy/sayingtshirt.jpg"width="100%"  alt="">
        </div>
        <div class="single-pro-details">
            <h6>Mens wear</h6>
            <h4>Saying t-shirt</h4>
            <h2>Rs 1000</h2>
            <select>
            ...
            <span>The saying t-shirt is made up of 100% cotton,this t-shirt provides unmatched comfort 
                with each wear.This t-shirt is one of the best seller outfit .
            </span>
        </div>
    </section>
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="dressesboy/sayingtshirt3.jpg" alt="">
                <div class="des">
                    <h5> Saying t-shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
